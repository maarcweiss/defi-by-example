...
contract LiquidityUSDT is IERC721Receiver {
        ...
        )
    {
        ...
        // Note that the pool defined by USDC/USDT and fee tier 0.01% must 
        ...
        )
    {
        ...
        TransferHelper.safeTransferFrom(USDT, msg.sender, address(this), amountAdd1);

        TransferHelper.safeApprove(USDC, address(nonfungiblePositionManager), amountAdd0);
        TransferHelper.safeApprove(USDT, address(nonfungiblePositionManager), amountAdd1);
